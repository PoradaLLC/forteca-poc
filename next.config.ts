...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com https://vercel.live https://connect.facebook.net https://link.msgsndr.com",
      "frame-src https://js.stripe.com https://booking.hospitable.com https://form.jotform.com https://vercel.live https://api.leadconnectorhq.com",
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://nominatim.openstreetmap.org https://api.stripe.com https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://vercel.live wss://ws-us3.pusher.com https://www.facebook.com https://connect.facebook.net https://api.leadconnectorhq.com https://link.msgsndr.com",
    ].join("; "),
  },
  {
